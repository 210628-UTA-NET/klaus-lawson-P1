...
COPY *.sln ./
COPY SABL/*.csproj SABL/
COPY SADL/*.csproj SADL/
COPY SAWebUI/*.csproj SAWebUI/
COPY SAModels/*.csproj SAModels/
...
RUN dotnet publish SAWebUI -c Release -o publish --no-restore
